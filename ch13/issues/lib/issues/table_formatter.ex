defmodule Issues.TableFormatter do
  ...
  Prints a table to STDOUT of the data from each row identified by each
  header. That is, each header identifies a column, and those columns are
  extracted and printed from the rows.
  We calculated the width of each column to fit the longest element in
  that column.
  """
  def print_with_columns(rows, headers) do
